...
type ExperiencesEditProps = {
    experience: Experience;
};

export default function Edit({ experience }: ExperiencesEditProps) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(experiencesRoutes.update.url(experience.id));
    }

    const showLogo = logoPreview || (experience.company_logo_url && !data.remove_logo);
            ...
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <h1 className="text-3xl font-black tracking-tight">Editar Experiencia</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="space-y-3">
                                    {showLogo && (
                                        <div className="flex items-center gap-4">
                                            <img
                                                src={logoPreview || experience.company_logo_url || ''}
                                                alt="Vista previa"
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        >
                            ...
                            {processing ? 'Guardando...' : 'Actualizar Experiencia'}
                        </Button>
                    </div>
                </form>
            </div>
