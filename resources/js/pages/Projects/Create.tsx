...
type ProjectsCreateProps = {
    technologies: Technology[];
};

export default function Create({ technologies }: ProjectsCreateProps) {
                    ...
                    <div className="space-y-5">
                        <div className="grid gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    className="mt-2 rounded-xl"
                                    placeholder="sistema-gestion-empresarial"
                                />
                        ...
                        <div>
                            ...
                            <Textarea
                                ...
                                placeholder="Descripción completa del proyecto, características, problemas resueltos, etc."
                            />
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    ...
                                    <span className="mt-1 text-xs text-muted-foreground/70">Puedes seleccionar múltiples imágenes</span>
                                    <input
                                        id="gallery"
                                        type="file"
                                        accept="image/*"
                                ...
                                {galleryPreviews.length > 0 && (
                                    <div className="mt-4 grid grid-cols-2 gap-3 md:grid-cols-4">
                                        {galleryPreviews.map((preview, index) => (
                                            <div key={index} className="relative aspect-video overflow-hidden rounded-lg border border-border/50">
                                                <img src={preview} alt={`Gallery ${index + 1}`} className="size-full object-cover" />
                                                <Button
                                                    type="button"
                                                    size="icon"
                                                    variant="destructive"
