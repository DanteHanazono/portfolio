...
export default function Create() {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(educationRoutes.store.url());
    }

    return (
        <AppLayout>
            <Head title="Nueva Formación" />
            ...
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <h1 className="text-3xl font-black tracking-tight">Nueva Formación</h1>
                        <p className="mt-1 text-sm text-muted-foreground">Agrega una nueva formación académica a tu portafolio</p>
                    </div>
                </div>
