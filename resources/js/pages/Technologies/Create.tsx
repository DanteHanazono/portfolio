...
export default function Create() {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(technologiesRoutes.store.url());
    }

    return (
        <AppLayout>
            <Head title="Nueva Tecnología" />
            ...
            <div className="mx-auto max-w-3xl space-y-8">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        <h1 className="text-3xl font-black tracking-tight">Nueva Tecnología</h1>
                        <p className="mt-1 text-sm text-muted-foreground">
                            Agrega una nueva tecnología a tu portafolio
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        >
                            ...
                            {processing ? 'Guardando...' : 'Guardar Tecnología'}
                        </Button>
                    </div>
                </form>
            </div>
